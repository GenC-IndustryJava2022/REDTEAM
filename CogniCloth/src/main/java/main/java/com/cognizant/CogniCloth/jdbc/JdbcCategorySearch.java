...
public class JdbcCategorySearch {

	public void create(Category c)
	{
		
	}
	public void select(Category c) throws SQLException, ClassNotFoundException {
		try 
		{    
	...
	public void delete(Category c) throws SQLException, ClassNotFoundException {
		try 
		{    
		        Connection con = DBConnection.getConnection();
			Statement smt = con.createStatement();
	...
	public void remove(Category c) throws SQLException, ClassNotFoundException {
		try 
		{    
		        Connection con = DBConnection.getConnection();
			Statement smt = con.createStatement();
